...
export default class extends SoundWorld {
  constructor(spaceConfig, userSettings) {
    super();
    this.file = 'UndergroundWarehouse.glb';
    this.displays = [];
    ...
    this.particleSources = [
      {
        position: new BABYLON.Vector3(-11.21, 4.312, 0.408),
        rotation: new BABYLON.Vector3(-0.013, -1.60, 0)
      },
      {
        position: new BABYLON.Vector3(-16.26, 6.105, -0.67),
        rotation: new BABYLON.Vector3(-0.0036, -1.14, 0)
      },
      {
        position: new BABYLON.Vector3(-23.642, 4.299, -0.40),
...
// TODO: find the best position and settings for this light
  ...
  buildCinecamConfig() {
    ...
    let cinecamSpawnPosition = { x: -1.508, y: 6.2381, z: -8.0719 };
